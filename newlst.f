...
* This section modified by Judson B. Tunnell - 13-Sept-2023
  ...
  500  FORMAT(5('='),1X,'Available spectral weighting functions mod :')
       DO is = 1, ns
          WRITE(50,505) is, slabel(is)
       ENDDO

       WRITE(50,510)
  510  FORMAT(5('='),1X,'Available photolysis reactions mod')
       DO ij = 1, nj
